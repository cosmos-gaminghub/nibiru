...
# import keys
hermes keys restore ${GAIA_B_E2E_CHAIN_ID} -n "val01-nibiru-b" -m "${GAIA_B_E2E_VAL_MNEMONIC}"
hermes keys restore ${GAIA_A_E2E_CHAIN_ID} -n "val01-nibiru-a" -m "${GAIA_A_E2E_VAL_MNEMONIC}"
