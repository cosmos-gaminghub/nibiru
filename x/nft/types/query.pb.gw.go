...
var (
	pattern_Query_NFT_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"cosmos-gaminghub", "nibiru", "nft", "denom_id", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
